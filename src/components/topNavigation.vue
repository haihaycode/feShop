        ...
        <nav
            ...
            <div class="flex items-center">
                <div class="flex items-center">
                    ...
                    <input v-model="searchQuery" @input="search" class="ml-2 outline-none bg-transparent w-full"
                        type="text" name="search" id="search" placeholder="Search..." />
                </div>
                <ul class="flex items-center space-x-6">
                    <li class="font-semibold text-gray-700 hidden md:block  hover:text-red-500">Home</li>
                    <li class="font-semibold text-gray-700 hidden md:block  hover:text-red-500">Supply</li>
                    <li :class="isAccountOpen ? 'text-red-500' : ''" class="hidden md:block hover:text-red-500"
                        @click="toggleAccount">
                        <!-- tài khoản -->
                    ...
                    <li class="hidden md:block hover:text-red-500">
                        <!-- thông báo  -->
